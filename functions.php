...
function life_scripts() {
	wp_enqueue_style( '_s-style', get_stylesheet_uri(), array(), life_VERSION );
	wp_style_add_data( '_s-style', 'rtl', 'replace' );

	wp_enqueue_script( '_s-navigation', get_template_directory_uri() . '/js/navigation.js', array(), life_VERSION, true );
